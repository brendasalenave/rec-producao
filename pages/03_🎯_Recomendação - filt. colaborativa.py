...
def get_connection():
    ...
    """
    conn = psycopg2.connect("postgres://ejykzgqonbhygs:97b583cb1013b70ca70b570aafbeac0a9cdc298198fbe5a90e836e32da67d93a@ec2-18-209-78-11.compute-1.amazonaws.com:5432/d8fhh13qpq4epf")
    return conn
...
def main():
    ...
    if input_text_1 and input_text_2 and input_text_3:
        ...
        df_GT100 = pd.read_parquet(csv_path)
        print(df_GT100.columns)
